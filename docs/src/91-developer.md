...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/jhidding/ModuleMixins.jl
   ```
...
- After that runs, the [stable docs](https://jhidding.github.io/ModuleMixins.jl/stable) should be updated. Check them and look for the version number.
